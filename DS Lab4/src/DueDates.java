 ...
 * Author: Linda Crane and xxxxxxxxxx Course: F2018 - CST8130 Lab Section:
 * xxxxxxxx Data members: * Methods: *
 *
 ************************************************************************************************************
 */
public class DueDates {
    ...
    public String toString() {
        //*****  write the code for this method here
        String result = "The due dates are :\n"
                + "";
        for (int i = 0; i < dueDates.length; i++) {
    ...
    public void insertionSort() throws ParseException {
        int n = dueDates.length;
        for (int j = 1; j < n; j++) {
            MyDate dateOne = dueDates[j];
            int i = j - 1;
            while ((i > -1) && (dueDates[i].isGreaterThan(dateOne))) {
                dueDates[i + 1] = dueDates[i];
                i--;
            }
            dueDates[i + 1] = dateOne;
        }
    }
